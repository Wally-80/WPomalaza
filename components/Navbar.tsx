...
export default function Sidebar() {
  ...
  const menuItems = [
    ...
    { name: t.nav.contact, href: '#contact', icon: '✉️' },
  ]
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed left-0 top-0 h-screen bg-gray-900 text-white w-64 z-40 transform transition-transform duration-300 ease-in-out ${
      ...
      >
        <div className="flex flex-col h-full p-6">
          ...
          <div className="flex flex-col items-center mb-8">
            <div className="relative w-32 h-32 mb-4 rounded-full overflow-hidden border-4 border-gray-700">
              <div className="w-full h-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-5xl font-bold">
                W
              </div>
            </div>
